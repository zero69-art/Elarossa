...
export const products: Product[] = [
  ...
  },
  {
    ...
    price: 44,
    tag: "NEW",
    description: "A refined two-piece swim silhouette for resort days, poolside afternoons and effortless vacation styling.",
    details: ["Two-piece swim silhouette", "Multiple sizes", "Designed for resort styling", samplePolicy],
    sizes: ["S", "M", "L", "XL"],
    colors: ["Black", "Ivory"],
  ...
  },
  {
    ...
    details: ["Minimal everyday design", "Soft-touch positioning", "Multiple sizes", samplePolicy],
    sizes: ["S", "M", "L", "XL"],
  ...
  },
  {
    ...
    compareAtPrice: 59,
    tag: "BESTSELLER",
    description: "A high-rise activewear staple designed for a streamlined silhouette, training days and elevated off-duty looks.",
    details: ["High-rise silhouette", "Stretch performance positioning", "Easy pairing with Elarossa activewear", samplePolicy],
    sizes: ["S", "M", "L", "XL"],
  ...
  },
  {
    ...
    compareAtPrice: 45,
    tag: "SMOOTH FIT",
    description: "A discreet bra designed for clean lines under fitted tops, dresses and occasionwear.",
  ...
  },
  {
    ...
    compareAtPrice: 52,
    tag: "NEW",
    description: "A polished everyday bra concept with a smooth finish and refined silhouette for modern wardrobes.",
  ...
  },
  {
    ...
    compareAtPrice: 68,
    tag: "RESORT EDIT",
    description: "A timeless one-piece designed to move from the pool to resort styling with a clean, sophisticated finish.",
    details: ["One-piece silhouette", "Resort-ready styling", "Classic wardrobe direction", samplePolicy],
    sizes: ["S", "M", "L", "XL"],
  ...
  },
  {
    ...
    compareAtPrice: 36,
    tag: "ESSENTIAL",
    description: "A minimal underwear essential built around a smooth, low-profile silhouette for everyday wear.",
  ...
  },
  {
    ...
    compareAtPrice: 29,
    tag: "STUDIO",
    description: "A polished studio accessory for Pilates, yoga and at-home movement routines.",
    details: ["Grip sole concept", "Studio and lounge use", "Easy add-on to activewear orders", samplePolicy],
    sizes: ["S/M", "L/XL"],
  ...
  },
  {
    ...
    compareAtPrice: 59,
    tag: "LOUNGE EDIT",
    description: "A fluid wide-leg silhouette designed for elevated lounging, travel days and polished everyday dressing.",
