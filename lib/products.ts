...
export const products: Product[] = [
  {
    ...
    gallery: ["https://images.unsplash.com/photo-1518611012118-696072aa579a?auto=format&fit=crop&w=1200&q=85"], supplier: "CJdropshipping", supplierCostMax: 6.99, shippingReserve: 5, qualityStatus: "sample-required"
  },
  {
    slug: "satin-hour-bikini", name: "Satin Hour Bikini", category: "Swimwear", price: 44, tag: "NEW",
    description: "A refined two-piece swim silhouette for resort days, poolside afternoons and effortless vacation styling.", details: ["Two-piece swim silhouette", "Multiple sizes", "Designed for resort styling", samplePolicy], sizes: ["S", "M", "L", "XL"], colors: ["Black", "Ivory"], image: "https://images.unsplash.com/photo-1570976447640-acf6b1b4b6f7?auto=format&fit=crop&w=1200&q=85", gallery: ["https://images.unsplash.com/photo-1570976447640-acf6b1b4b6f7?auto=format&fit=crop&w=1200&q=85"], supplier: "CJdropshipping", supplierCostMax: 10, shippingReserve: 5, qualityStatus: "sample-required"
  },
  {
    slug: "second-skin-everyday-bra", name: "Second-Skin Everyday Bra", category: "Intimates", price: 34, tag: "EVERYDAY",
    description: "A minimalist everyday layer focused on a smooth silhouette and understated comfort.", details: ["Minimal everyday design", "Soft-touch positioning", "Multiple sizes", samplePolicy], sizes: ["S", "M", "L", "XL"], colors: ["Black", "Nude", "White"], image: "https://images.unsplash.com/photo-1596755389378-c31d21fd1273?auto=format&fit=crop&w=1200&q=85", gallery: ["https://images.unsplash.com/photo-1596755389378-c31d21fd1273?auto=format&fit=crop&w=1200&q=85"], supplier: "CJdropshipping", supplierCostMax: 8, shippingReserve: 5, qualityStatus: "sample-required"
  },
  {
  ...
  },
  {
    ...
    description: "A discreet bra designed for clean lines under fitted tops, dresses and occasionwear.", details: ["Traceless positioning", "Backless styling", "Designed for fitted outfits", samplePolicy], sizes: ["S", "M", "L", "XL"], colors: ["Black", "Nude", "White"], image: "https://images.unsplash.com/photo-1529139574466-a303027c1d8b?auto=format&fit=crop&w=1200&q=85", gallery: ["https://images.unsplash.com/photo-1529139574466-a303027c1d8b?auto=format&fit=crop&w=1200&q=85"], supplier: "CJdropshipping", supplierCostMax: 6, shippingReserve: 5, qualityStatus: "sample-required"
  },
  {
    slug: "gloss-seamless-memory-bra", name: "Gloss Seamless Memory Bra", category: "Intimates", price: 42, compareAtPrice: 52, tag: "NEW",
    description: "A polished everyday bra concept with a smooth finish and refined silhouette for modern wardrobes.", details: ["Seamless construction", "Smooth finish positioning", "Everyday-to-occasion versatility", samplePolicy], sizes: ["S", "M", "L", "XL"], colors: ["Black", "Cocoa", "Nude"], image: "https://images.unsplash.com/photo-1525507119028-ed4c629a60a3?auto=format&fit=crop&w=1200&q=85", gallery: ["https://images.unsplash.com/photo-1525507119028-ed4c629a60a3?auto=format&fit=crop&w=1200&q=85"], supplier: "CJdropshipping", supplierCostMax: 4.87, shippingReserve: 5, qualityStatus: "sample-required"
  },
  {
    ...
    description: "A timeless one-piece designed to move from the pool to resort styling with a clean, sophisticated finish.", details: ["One-piece silhouette", "Resort-ready styling", "Classic wardrobe direction", samplePolicy], sizes: ["S", "M", "L", "XL"], colors: ["Black", "Ivory", "Deep Olive"], image: "https://images.unsplash.com/photo-1539109136881-3be0616acf4b?auto=format&fit=crop&w=1200&q=85", gallery: ["https://images.unsplash.com/photo-1539109136881-3be0616acf4b?auto=format&fit=crop&w=1200&q=85"], supplier: "CJdropshipping", supplierCostMax: 12, shippingReserve: 5, qualityStatus: "sample-required"
  },
  {
    ...
    description: "A minimal underwear essential built around a smooth, low-profile silhouette for everyday wear.", details: ["Seamless positioning", "Low-profile silhouette", "Designed as an everyday essential", samplePolicy], sizes: ["S", "M", "L", "XL"], colors: ["Black", "Nude", "White"], image: "https://images.unsplash.com/photo-1483985988355-763728e1935b?auto=format&fit=crop&w=1200&q=85", gallery: ["https://images.unsplash.com/photo-1483985988355-763728e1935b?auto=format&fit=crop&w=1200&q=85"], supplier: "CJdropshipping", supplierCostMax: 7.6, shippingReserve: 5, qualityStatus: "sample-required"
  },
  {
    slug: "pilates-grip-studio-socks", name: "Pilates Grip Studio Socks", category: "Activewear", price: 24, compareAtPrice: 29, tag: "STUDIO",
    description: "A polished studio accessory for Pilates, yoga and at-home movement routines.", details: ["Grip sole concept", "Studio and lounge use", "Easy add-on to activewear orders", samplePolicy], sizes: ["S/M", "L/XL"], colors: ["Black", "Cream", "Stone"], image: "https://images.unsplash.com/photo-1490481651871-ab68de25d43d?auto=format&fit=crop&w=1200&q=85", gallery: ["https://images.unsplash.com/photo-1490481651871-ab68de25d43d?auto=format&fit=crop&w=1200&q=85"], supplier: "CJdropshipping", supplierCostMax: 2, shippingReserve: 5, qualityStatus: "sample-required"
  },
  {
    ...
    description: "A fluid wide-leg silhouette designed for elevated lounging, travel days and polished everyday dressing.", details: ["Wide-leg silhouette", "Relaxed fit direction", "Designed for travel and lounge styling", samplePolicy], sizes: ["S", "M", "L", "XL"], colors: ["Black", "Champagne", "Espresso"], image: "https://images.unsplash.com/photo-1485968579580-b6d095142e6e?auto=format&fit=crop&w=1200&q=85", gallery: ["https://images.unsplash.com/photo-1485968579580-b6d095142e6e?auto=format&fit=crop&w=1200&q=85"], supplier: "CJdropshipping", supplierCostMax: 10.14, shippingReserve: 5, qualityStatus: "sample-required"
  }
];
