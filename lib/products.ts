...
import { midSkus } from "./products-mid-skus";
...
const catalogProducts: Product[] = [
  {
    ...
    tag: "FOUNDING EDIT",
    description:
      "High-rise seamless leggings with a sculpting scrunch back and soft stretch for studio sessions, training and everyday movement.",
    ...
    video:
      "https://download-only-api.cjdropshipping.com/e026d4aa6f2871ef800d4531958d0102/b6786e41fa10465b926e5b6ec8ec3409-07c532b7732e8519552a3c762e0d3ba4-ld.mp4",
  },
  {
    ...
    tag: "NEW",
    description:
      "Seamless high-waist yoga shorts with a close fit for Pilates, studio work and warm-weather movement.",
    ...
    video:
      "https://download-only-api.cjdropshipping.com/7044060c138971f080246733a78e0102/22b2f786c9fa4fb4a3ecca8951faad90-29ec7b2d98bac382b391e2d3db10ab3f-ld.mp4",
  },
  {
    ...
    tag: "NEW",
    description:
      "Butt-lift scrunch shorts in seamless stretch for gym days, walks and low-impact training.",
  ...
  },
  {
    ...
    tag: "STUDIO",
    description:
      "Seamless nylon-blend leggings with moisture-wicking positioning for yoga and training.",
  ...
  },
  {
    ...
    tag: "EVERYDAY",
    description:
      "Seamless sports bra with soft shaping and breathable stretch for low-to-medium impact movement and everyday layering.",
  ...
  },
  {
    ...
    tag: "ESSENTIAL",
    description:
      "Low-profile seamless briefs designed for a smooth line under clothing in soft stretch nylon.",
  ...
  },
  {
    ...
    tag: "SMOOTH FIT",
    description:
      "Discreet backless bra designed for clean lines under fitted tops, dresses and occasionwear.",
    ...
    video:
      "https://download-only-api.cjdropshipping.com/2b2ef4284c5240bc93d5b1d863c849af/344d7d03ef52449583ffbac4ba868f34-bf5ae9ac046c609df1d507cbed7fc78e-ld.mp4",
  },
  {
    ...
    video:
      "https://download-only-api.cjdropshipping.com/f8771820c46c71edacb06632b68f0102/6f24ff242f1746b29a8d3d65501ea94d-4dbf892a4360fbb9bf3da030af983fe4-ld.mp4",
  },
];

export const products: Product[] = [
  ...catalogProducts,
  ...(midSkus as typeof catalogProducts),
  ...(newSkus as typeof catalogProducts),
];
